! function(e, t) {
	...
	return function(e) {
		...
		function u(e, t) {
			function n(t) {
				...
				return n && n !== !0 || null !== r ? (t = {
					pathname: t,
					query: n
				}, o = r || !1) : (t = e.createLocation(t), o = n), (0, d["default"])(t, o, _.location, _.routes, _.params)
			}
			...
			function u(e, t) {
				...
				var o = (0, c["default"])(_, e),
					...
					i = o.changeRoutes,
					s = o.enterRoutes;
				(0, f.runLeaveHooks)(u, _), u.filter(function(e) {
			...
			function l(e, n) {
				(0, y["default"])(t, e, function(t, r) {
					...
					for(var o = s((0, c["default"])(_, R).leaveRoutes), u = void 0, i = 0, f = o.length; null == u && i < f; ++i) u = o[i](e);
					n(u)
				})
			}
			...
			function v(e) {
				var t = i(e, !1);
				t && (delete b[t], o(b) || (P && (P(), P = null), w && (w(), w = null)))
			}

			function m(t, n) {
				var r = i(t),
					u = b[r];
				if(u) u.indexOf(n) === -1 && u.push(n);
				else {
					var a = !o(b);
					b[r] = [n], a && (P = e.listenBefore(l), e.listenBeforeUnload && (w = e.listenBeforeUnload(p)))
				}
				return function() {
					var e = b[r];
					if(e) {
		...
		var c = Object.assign || function(e) {
			...
			b = l["default"].createClass({
				...
				render: function() {
					...
					if(h) {
						if(null == t) return l["default"].createElement("a", p);
						var v = s(t, {
							query: n,
							hash: r,
							state: u
		...
		var o = n(1),
			...
			f = {
				...
				componentDidMount: function() {
					...
					e ? void 0 : (0,
						s["default"])(!1), this._unlistenBeforeLeavingRoute = this.context.history.listenBeforeLeavingRoute(e, this.routerWillLeave)
				},
		...
		var i = Object.assign || function(e) {
			...
			j = v["default"].createClass({
				...
				createRouterObjects: function() {
					...
					var i = (0, m["default"])(t, (0, O.createRoutes)(r || o)),
						s = (0, b.createRouterObject)(t, i),
						c = (0, b.createRoutingHistory)(t, i);
					return {
						history: c,
						transitionManager: i,
						router: s
		...
		function u(e, t) {
			...
			n || u ? void 0 : (0, c["default"])(!1), n = n ? n : (0, l["default"])(s);
			var f = (0, p["default"])(n, (0, h.createRoutes)(r)),
				d = void 0;
			u ? u = n.createLocation(u) : d = n.listen(function(e) {
				u = e
			});
			var y = (0, v.createRouterObject)(n, f);
			n = (0, v.createRoutingHistory)(n, f), f.match(u, function(e, r, o) {
				t(e, r && y.createLocation(r, i.REPLACE), o && a({}, o, {
					history: n,
					router: y,
					matchContext: {
						history: n,
